...
namespace ClienteCadastro
{
    public partial class frmCadastroCliente : Form
    {
        ...
        public void btnIncluir_Click(object sender, EventArgs e)
        {
            ...
            sqlQuery = "INSERT INTO cliente(nome,data_nasc,cpf,Endereco,Telefone) VALUES(@nome,@data_nasc,@cpf,@Endereco,@Telefone)";
            ...
            try
            {
                ...
                cmd.Parameters.Add(new SqlParameter("@Endereco", txtEndereco.Text));
                cmd.Parameters.Add(new SqlParameter("@Telefone", mskTelefone.Text));
        ...
        public void btnAlterar_Click(object sender, EventArgs e)
        {
            ...
            //cria a instrução sql, parametrizada
            sqlQuery = "UPDATE cliente set nome=@nome,data_nasc=@data_nasc,cpf=@cpf,Endereco=@Endereco,Telefone=@Telefone WHERE id_cliente=@id_cliente";
